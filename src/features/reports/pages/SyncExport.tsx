...
export default function SyncExport() {
  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen relative pb-32">
      <header className="flex items-center w-full px-4 h-16 fixed top-0 z-50 bg-surface dark:bg-slate-950 font-manrope font-semibold text-xl transition-colors duration-200">
        <button className="mr-4 p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors active:scale-95 duration-200 flex items-center justify-center text-blue-700 dark:text-blue-400">
          <span className="material-symbols-outlined">arrow_back</span>
        </button>
        <h1 className="font-manrope font-bold text-blue-700 dark:text-blue-400 flex-1">Edit Account</h1>
      </header>

      <main className="pt-24 px-6 md:px-12 max-w-3xl mx-auto space-y-12">
        <div className="mb-8">
        ...
        <section className="bg-surface-container-low rounded-xl p-6 md:p-8 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <button className="bg-primary text-on-primary font-headline font-semibold text-title-md px-6 py-3 rounded-xl hover:bg-primary-fixed-variant transition-colors flex items-center justify-center gap-2 active:scale-95 duration-150">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-4 bg-surface-container-lowest rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body text-body-md font-medium text-on-surface">pf_backup_latest.enc</p>
                    <p className="font-body text-label-sm text-on-surface-variant">Today • encrypted</p>
                  </div>
                </div>
                <button className="text-primary hover:text-primary-container p-2 transition-colors" aria-label="Download snapshot">
              ...
              <div className="flex items-center justify-between p-4 bg-transparent rounded-lg">
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined text-outline">folder_zip</span>
                  <div>
                    <p className="font-body text-body-md font-medium text-on-surface">pf_backup_2023_09.enc</p>
                    <p className="font-body text-label-sm text-on-surface-variant">Sep 15, 2023 • 2.1 MB</p>
                  </div>
                </div>
                <button className="text-primary hover:text-primary-container p-2 transition-colors" aria-label="Download snapshot">
                  <span className="material-symbols-outlined">download</span>
