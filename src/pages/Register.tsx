      ...
      <main className="flex-1 overflow-y-auto px-8 pt-10 pb-10 flex flex-col">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 flex flex-col space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  {...register('fullName')}
                  type="text"
                  className={`w-full h-14 pl-12 pr-4 bg-surface-container-high rounded-2xl border-none focus:ring-2 focus:ring-primary text-on-surface placeholder:text-outline/50 font-medium transition-all ${errors.fullName ? 'ring-2 ring-error' : ''
                    }`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  {...register('email')}
                  type="email"
                  className={`w-full h-14 pl-12 pr-4 bg-surface-container-high rounded-2xl border-none focus:ring-2 focus:ring-primary text-on-surface placeholder:text-outline/50 font-medium transition-all ${errors.email ? 'ring-2 ring-error' : ''
                    }`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full h-14 pl-12 pr-12 bg-surface-container-high rounded-2xl border-none focus:ring-2 focus:ring-primary text-on-surface placeholder:text-outline/50 font-medium transition-all ${errors.password ? 'ring-2 ring-error' : ''
                    }`}
          ...
          <div className="space-y-3">
            <button type="button" className="w-full h-14 bg-surface-container border border-outline-variant/40 text-on-surface hover:bg-surface-container-high transition-colors rounded-2xl flex items-center justify-center gap-3 font-semibold active:scale-[0.98]">
