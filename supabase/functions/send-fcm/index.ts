...
//     const notificationRecord = body.record; // Triggered by webhook: { record: { user_id, title, message, link } }
...
//     // 3. Fetch user's registered FCM tokens
...
//     // 4. Retrieve Firebase Service Account JSON from secret
...
//     // 6. Send push notifications to all registered devices of the user
...
//         // Optional: delete invalid token from DB if registered token is expired/unregistered
